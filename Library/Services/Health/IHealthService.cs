...
namespace Services
{
    public interface IHealthService
    {
        ...
        IPagedList<VHealthAuditList> GetHealthList(int status = 0, DateTime? beginDate = null, DateTime? endDate = null, string productName = null, int pageIndex = 1, int pageSize = 15);
